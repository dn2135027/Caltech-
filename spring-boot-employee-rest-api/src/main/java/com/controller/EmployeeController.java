...
public class EmployeeController {
	...
	// http://localhost:9090/updateEmployeeSalary	format must be in json format  
		...
		// http://localhost:9090/deleteEmployee/1000
